...
Response:   AI helps improve efficiency in transportation by making it so that we need less bus, taxi, and delivery drivers. There is already a shortage of drivers so AI could help fill those spots. Also, many accidents are caused due to human misunderstandings and a lack of focus. It is unlikely that accidents would occur for the same reasons if AI was operating vehicles. Of course, AI can still make mistakes which is why it would take a lot of fine tuning to rely on it completely. In short, many accidents in tranportation could be prevented if people and AI worked together to operate rather than relying entirely on either party.
  AI can cause harm if it is relied on completely for recognition programs because many things, especially living beings, come in different shapes and sizes. It is very difficult to program a machine to classify certain images as the same item if they can have many different characteristics. In the linked videos, the AI could only recognize faces that had certain features, but it was unable to detect a face because the characteristics were slightly different. It would take much more work to teach AI how to recognize something as a face when they can look so many different ways. Additionally, people have already used AI to alter their appearance online which can make it much easier to catfish others online. In short, AI struggles with recognizing the faces of many different people and it can be used to make the internet even unsafe than it is.
